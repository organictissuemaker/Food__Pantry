...
class PantryManager {
    ...
    func fillLists() -> Void {
        for item in pantryItems {
            ...
            if (item.type == foodCategory.veg) {
                listVeg.append(item)
            } else if (item.type == foodCategory.fruit) {
                listFruits.append(item)
            } else if (item.type == foodCategory.canned) {
                listCans.append(item)
            } else if (item.type == foodCategory.dairy) {
                listDairy.append(item)
            } else if (item.type == foodCategory.other) {
